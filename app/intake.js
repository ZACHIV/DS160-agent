...
const BOOLEAN_PATHS = [
  ...
  "security_background.yes_no_answers.communicable_disease",
  "security_background.yes_no_answers.mental_physical_disorder",
  "security_background.yes_no_answers.substance_abuse",
  "security_background.yes_no_answers.arrest_history",
  "security_background.yes_no_answers.immigration_violation",
  "security_background.yes_no_answers.us_removal",
  "security_background.yes_no_answers.terrorist_activity",
  "security_background.yes_no_answers.insurgent_service",
  ...
  var payload = {
    ...
    security_background: {
      yes_no_answers: {
        ...
        mental_physical_disorder: checkbox("security_background.yes_no_answers.mental_physical_disorder"),
        substance_abuse: checkbox("security_background.yes_no_answers.substance_abuse"),
        arrest_history: checkbox("security_background.yes_no_answers.arrest_history"),
        immigration_violation: checkbox("security_background.yes_no_answers.immigration_violation"),
        us_removal: checkbox("security_background.yes_no_answers.us_removal"),
        terrorist_activity: checkbox("security_background.yes_no_answers.terrorist_activity"),
        insurgent_service: checkbox("security_background.yes_no_answers.insurgent_service"),
